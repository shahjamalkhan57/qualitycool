    ...
    <section className="relative overflow-hidden py-20 pt-32">
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          >
            <span className="text-sm font-medium text-emerald-800 dark:text-emerald-300">HVAC Resources</span>
          </motion.div>

          <motion.h1 variants={itemVariants} className="mb-6 text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
            HVAC{" "}
            <span className="bg-gradient-to-r from-emerald-600 to-emerald-400 bg-clip-text text-transparent">Blog</span>{" "}
            & Tips
          </motion.h1>

          <motion.p variants={itemVariants} className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
            Explore our blog for HVAC maintenance tips, energy-saving advice, and the latest industry news.
          </motion.p>
          ...
          <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-6">
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Expert Advice</span>
            </motion.div>
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Helpful Guides</span>
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
